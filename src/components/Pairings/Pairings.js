...
const Pairings = () => (
    ...
    <div>
        ...
        <br></br>
            ...
            <div class="bracket-game">
                <div class="player top win"> Pikachu
                <div class="score"> 4 </div>
            </div>
                <div class="player bot loss"> Horsea
                <div class="score"> 2 </div>
            </div>
    </div>
    ...
    <div> 
        ...
        <br></br> <br></br> <br></br><br></br>
            ...
            <div class="bracket-game">
                ...
                <div class="player bot loss"> Machop
                <div class="score"> 2
             </div>
        </div>
    </div>
    ...
    <br></br> <br></br> <br></br> <br></br> <br></br>
            ...
            <div class="bracket-game cont">
                <div class="player top loss"> Pikachu
    ...
    <br></br> <br></br> <br></br> <br></br> 
            ...
            <div class="bracket-game">
                ...
                <div class="player bot loss"> Jynx
                <div class="score"> 1
            </div>
        </div>
    </div>
